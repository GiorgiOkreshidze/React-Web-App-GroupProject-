        ...
        <select className='category' value={selectedCategory} onChange={(e) => handleCategoryChange(e.target.value)}>
          ...
          {categories.map((category) => (
            <option key={category.category_id}>
              <strong></strong> {category.title}<br />
            </option>
          ))}
        </select>
      </div>
