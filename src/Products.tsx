        ...
        <div className='search-content w-100'>
          <div className="d-sm-flex d-none justify-content-between align-items-center mt-md-0 mb-2 mb-md-3 px-3 px-md-0">
            ...
            <div className="d-flex align-items-center" >
              ...
              <select className='d-flex align-items-center position-relative undefined' onClick={sortCars} 
              style={{      
                boxSizing: 'border-box',
                flexDirection: 'row',
                justifyContent: 'space-between',
            ...
            {products.map((product) => (
              <div className='product px-3 px-md-0 position-relative'>
                <div className="rounded mb-3 bg-white"  /*mb-10px*/
                  ...
                  <div className='photoAndInfo d-sm-flex flex-md-row p-md-2' /*p-md-16px*/ >
                    <div className="photo flex-shrink-0 w-md-200px mb-3 mb-md-0 px-3 px-md-0" /* mb-12px mb-m-0 px-16px px-m-0*/ style={{
                      ...
                      <div className='info pl-md-2 d-flex flex-column justify-content-between w-100'/*pl-m-14px*/ >
                        ...
                        <div className='d-flex flex-md-row justify-content-between'>
                          ...
                          /*px-12px p-m-0 mx-16px mx-m-0 mt-8px mt-m-0*/>
                            <div className="row justify-content-between justify-content-md-start mx-n2 mx-md-n3 my-md-n2" /*mx-n8px mx-md-n12px my-m-n10px*/>
                          ...
                          <div className="d-flex flex-lg-column align-items-center align-items-lg-end justify-content-between justify-content-lg-start p-3 p-md-0 w-50 w-lg-auto" /*p-16px*/> 
                            <div className="d-flex flex-column mb-lg-3"/*mb-lg-12px*/>
                              <div className="d-flex align-items-center justify-content-md-end mt-lg-n1" /*mt-lg-n4px*/> 
                        ...
                        <div className="d-flex justify-content-between align-items-center border-solid-1 border-solid-m-0 py-3 px-3 p-m-0 border-gray-100" /*py-12px px-16px*/ style={{
                          ...
                          <div className="d-flex">
                            <button type="button" className="action-icon tooltip-parent border-0 bg-transparent ml-1 w-50 h-50 
                            ...
                            <button type="button" className="action-icon tooltip-parent border-0 bg-transparent w-50 h-50
                            rounded-xs d-flex align-items-center justify-content-center cursor-pointer transition-all ml-1" /* w-24px h-24px ml-8px*/ >
                              <svg width="16" height="16" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <button type="button" className="{`carIcon ${activeButton === 'carIcon' ? 'active' : ''}`}action-icon tooltip-parent border-0 bg-transparent ml-1 w-50 h-50 
                            rounded-xs d-flex align-items-center justify-content-center hover-icon-orange cursor-pointer transition-all "
                             onClick={() => likeClick('likeClick')} /** ml-8px w-24px h-24px */ >
                              <svg width="16" height="16" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
